...
const shareCodes = [
  {
    zd: $.getdata("zd_shareCode1") || "hi5pfpi6tw2vje63si5hwaj7mis4u2u5xzpnppa",
    nc: $.getdata("nc_shareCode1") || "da7ae46e2b4343319662f5d992a49157",
    mc: $.getdata("mc_shareCode1") || "MTE1NDQ5OTUwMDAwMDAwNDMxNzU1MzE=",
    ddgc: $.getdata("dd_shareCode1") || "T024ZnLalJakI_xI9JdkQ12-rYeMCjVWnYaS5kRrbA",
    jxgc: $.getdata("jx_shareCode1") || "D0JiMXQ3EcBoaVjHe6G6vFrisrfyE4L_3C39_iCAM1M=",
  }
];
$.result = [];
